...
import { schemaTestCaseRoutes } from "./routes/schemaTestCases";
...
const app2 = app.route("/exhaustive", exhaustiveRoutes).route("/docs", docs).route("/test-cases", schemaTestCaseRoutes);
